      ...
      <nav id="navbar">
        <div className="wrapper">
          ...
          <ul className="nav-links">
            <label className="cancel-btn" htmlFor="cancelBtn"><i class="fa-sharp fa-solid fa-xmark"></i></label>
            <li>
              <a className="desktop-item"  href="">About</a>
              <input type="checkbox" name="" id="About-showMega" />
              <label className="mobile-item"  htmlFor="About-showMega">About</label>
            ...
            <li>
              <a className="desktop-item" href="">Services</a>
              <input type="checkbox" name="" id="Service-showMega" />
              <label className="mobile-item"  htmlFor="Service-showMega">Services</label>
            ...
            <li>
              <a className="desktop-item" href="">Contact</a>
              <input type="checkbox" name="" id="Contact-showMega" />
              <label className="mobile-item"  htmlFor="Contact-showMega">Contact</label>
            ...
            <li>
              <a className="desktop-item " href="">Blog</a>
              <input type="checkbox" name="" id="showDrop" />
              <label className="mobile-item"  htmlFor="showDrop">Blog</label>
          ...
          <button id="nav-btn" className="btn btn-outline-dark nav-btn px-4 py-2 rounded-pill ">
            Free Quote
          </button>
          <label htmlFor="menuBtn"><i class="bar-btn fa-sharp fa-solid fa-bars"></i></label>
